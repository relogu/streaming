...
def get_partitions_orig(num_samples: int,
    ...
    if num_samples > num_canonical_nodes or (num_samples == num_canonical_nodes and
        ...
        ids += row_starts - ids[:, :1]  # type: ignore[reportGeneralTypeIssues]
        ...
        are_rows_short = row_stops - row_starts < samples_per_canonical_node  # type: ignore[reportGeneralTypeIssues]
